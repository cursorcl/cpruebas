      ...
      if (entity instanceof Alumno) {
        ...
        for (Object iEntity : list) {
          ...
          if (itemColegio == null || !ot.getColegio().equals(itemColegio.getValue().getColegio())) {
            ...
            itemColegio =
                new TreeItem<OTAlumno>(otColegio, new ImageView(new Image(getClass()
                    .getResourceAsStream("school-icon1_16.png"))));
          ...
          if (itemCurso == null || !ot.getCurso().equals(itemCurso.getValue().getCurso())) {
            ...
            itemCurso =
                new TreeItem<OTAlumno>(otCurso, new ImageView(new Image(getClass()
