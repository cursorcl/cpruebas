...
public class AlumnosView extends AFormView {
  ...
  private void accionClicTabla() {
    tblAlumnos.setOnMouseClicked(new EventHandler<MouseEvent>() {
      ...
      public void handle(MouseEvent event) {
        ObservableList<Alumno> itemsSelec = tblAlumnos.getSelectionModel().getSelectedItems();
  ...
  private void accionEliminar() {
    mnItemEliminar.setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        ObservableList<Alumno> alumnosSelec = tblAlumnos.getSelectionModel().getSelectedItems();
  ...
  private void inicializaTabla() {
    ...
    colRut.setCellValueFactory(new PropertyValueFactory<Alumno, String>("rut"));
    colName.setCellValueFactory(new PropertyValueFactory<Alumno, String>("name"));
    colPaterno.setCellValueFactory(new PropertyValueFactory<Alumno, String>("paterno"));
    colMaterno.setCellValueFactory(new PropertyValueFactory<Alumno, String>("materno"));
    colCurso.setCellValueFactory(new PropertyValueFactory<Alumno, String>("curso"));
  ...
  public void onDataArrived(List<IEntity> list) {
    ...
    if (list != null && !list.isEmpty()) {
      ...
      if (entity instanceof Alumno) {
        ObservableList<Alumno> oList = FXCollections.observableArrayList();
