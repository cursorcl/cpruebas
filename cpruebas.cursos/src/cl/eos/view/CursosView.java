...
public class CursosView extends AFormView implements EventHandler<ActionEvent> {
  ...
  private ObservableList<R_Ciclo> lstCiclos;
  private ObservableList<R_Colegio> lstColegios;
  ...
  public void initialize() {
    ...
    cmbColegio.setOnAction(h -> {
      ...
      controller.findByParam(R_Curso.class, params, this);
    });
    ...
    if (list != null && !list.isEmpty()) {
      ...
      if (entity instanceof R_Curso) {
        ...
        for (final Object iEntity : list) {
          ...
          ot.setTipoCurso(tipoCurso);
          R_Ciclo ciclo = lstCiclos.stream().filter(c -> c.getId().equals(curso.getCiclo_id()))
  ...
  public void onSaved(IEntity otObject) {
    ...
    R_TipoCurso p_tipoCurso =
        controller.findSynchroById(R_TipoCurso.class, curso.getTipocurso_id());
