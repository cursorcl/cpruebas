...
public class OTPruebaRendida {
  ...
  private final SimpleObjectProperty<R_RangoEvaluacion> nivel = new SimpleObjectProperty<>();
  private final SimpleObjectProperty<R_TipoAlumno> tipoAlumno = new SimpleObjectProperty<>();
  ...
  /**
   * @return the tipoAlumno
   */
  public final R_TipoAlumno getTipoAlumno() {
    return tipoAlumno.get();
  }

  public SimpleObjectProperty<R_TipoAlumno> tipoAlumnoProperty() {
    return tipoAlumno;
  }
   ...
   */
  public final void setTipoAlumno(R_TipoAlumno tipoAlumno) {
    this.tipoAlumno.set(tipoAlumno);
    pruebaRendida.setTipoalumno_id(tipoAlumno.getId());
  }
