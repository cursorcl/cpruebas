...
/**
 * Realiza el analisis de una imagen, obtiene el rut del alumno y las respuestas que el alumno ha
 * seleccionado. Generando una imagen de cada una de los elementos que son procesados. El
 * pre-procesamiento se realiza a nivel de toda la imagen.
 */
public class ExtractorResultadosImagenesPrueba extends AExtractorResultados {
  ...
  public ExtractorResultadosImagenesPrueba() throws IOException {
    recognizerRespustas = RecognizerFactory.create(new File("./res/red_1.red"));
    recognizerRut = RecognizerFactory.create(new File("./res/red_rut.red"));
  }

  public static ExtractorResultadosImagenesPrueba getInstance() throws IOException {
    if (instance == null) {
