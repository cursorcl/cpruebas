...
public class SimpleTable {
     ...
     * won't exist. When opened in MS Word, the table style becomes "Normal". I
     * manually set alternating row colors. This could be done using Themes, but
     * that's left as an exercise for the reader. The cells in the last column
     * of the table have 10pt. "Courier" font. I make no claims that this is the
