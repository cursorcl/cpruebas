...
public class MainController {
  ...
  private R_Usuarios usuario;
  private ContextMenu contextMenu;
  private List<R_Clientes> lstClientes;
  private ListadoPruebasActivator activator;
  ...
  public void initialize() {
    try {
      ...
      activator = new ListadoPruebasActivator();
    ...
    txtCliente.setOnContextMenuRequested(new EventHandler<ContextMenuEvent>() {
      @Override
      public void handle(ContextMenuEvent event) {
        contextMenu.show(txtCliente, event.getScreenX(), event.getScreenY());
      }
    });
  }
  ...
  public void setCliente(R_Clientes cliente) {
    this.cliente = cliente;
    this.txtCliente.setText(cliente.getName());
  }

  public void setUsuario(R_Usuarios usuario) {
   ...
   * @return the usuario
   */
  public final R_Usuarios getUsuario() {
    return usuario;
  }
   ...
   * @return the cliente
   */
  public final R_Clientes getCliente() {
    return cliente;
  }

  public void setClientes(List<R_Clientes> lstClientes) {
    this.lstClientes = lstClientes;
    contextMenu.getItems().clear();
    ToggleGroup toggleGroup = new ToggleGroup();
    for (R_Clientes lcliente : lstClientes) {
      RadioMenuItem mnuItem = new RadioMenuItem(lcliente.getName());
      mnuItem.setSelected(lcliente.equals(this.cliente));
      mnuItem.setToggleGroup(toggleGroup);
      mnuItem.setOnAction(new EventHandler<ActionEvent>() {

        @Override
        public void handle(ActionEvent event) {
          chageClient(lcliente);
        }
      });

      contextMenu.getItems().add(mnuItem);
    }
  }
   ...
   */
  public final List<R_Clientes> getLstClientes() {
    return lstClientes;
  }
   ...
   */
  public final void setLstClientes(List<R_Clientes> lstClientes) {
    setClientes(lstClientes);
  }

  protected void chageClient(R_Clientes lcliente) {
    Environment.client = lcliente.getId();
    this.setCliente(lcliente);
    activator.getController().findAll(R_Prueba.class, (IPersistenceListener) activator.getController());
