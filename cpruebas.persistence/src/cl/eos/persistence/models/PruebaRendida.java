...
//	  
  ...
  /**
   * Este metodo recalcula la nota y el rango de la prueba rendida. Esto se hace cuando se ha
   * realizado una anulación de alguna pregunta.
   */
  public void reEvaluate() {
    ...
    float nota =
        Utils.getNota(nroPreguntas, prueba.getExigencia(), buenas, prueba.getPuntajeBase());
