...
public class PersistenceService implements IPersistenceService {
    ...
    public IEntity delete(IEntity entity) {
        ...
        try {
            ...
            mEntity = null;
            PersistenceService.LOG.severe(exception.getMessage());
        }
        return mEntity;
    }
    ...
    public int executeUpdate(final String namedQuery, Map<String, Object> parameters) {
        ...
        try {
            ...
            PersistenceService.LOG.severe("Error en el executeUpdate de:" + namedQuery + " / " + e.getMessage());
            ...
            protected List<Object> call() throws Exception {
                ...
                if (query != null) {
                    ...
                    try {
                        ...
                        eManager.getTransaction().rollback();
                        PersistenceService.LOG.severe("Error en el findByAllId de la entidad:" + entityClazz.getName()
                                + " / " + e.getMessage());
                    }
                }
                eManager.close();
            ...
            protected IEntity call() throws Exception {
                ...
                if (query != null) {
                    ...
                    try {
                        ...
                        eManager.getTransaction().rollback();
                        PersistenceService.LOG.severe("Error en el findByName de la entidad:" + entityClazz.getName()
                                + " / " + e.getMessage());
                    }
    ...
    public List<Object> findSynchro(final String namedQuery, final Map<String, Object> parameters) {
        ...
        if (query != null) {
            ...
            try {
                ...
                eManager.getTransaction().rollback();
                PersistenceService.LOG.severe("Error en el find del namedQuery:" + namedQuery + " / " + e.getMessage());
            }
