...
public class Nivel_ComparativoColegioEjeEvaluacionView extends AFormView implements EventHandler<ActionEvent> {
    ...
    private ObservableList<STipoCurso> tipoCursoList;
    ...
    public void onDataArrived(List<Object> list) {
        ...
        if (entity instanceof SCurso) {
            ...
            for (Object iEntity : list) {
                ...
                if (!tipoCursoList.contains(curso.getTipoCurso())) {
                    tipoCursoList.add(curso.getTipoCurso());
                }
            }
    ...
    private void llenarColumnas(ObservableList<STipoCurso> pCursoList, ObservableList<SRangoEvaluacion> rangos) {
    ...
    private void generarReporte() {
        ...
        for (SEvaluacionPrueba eval : evaluacionesPrueba) {
            ...
            for (SPruebaRendida pruebaRendida : pruebasRendidas) {
                ...
                int index = tipoCursoList.indexOf(pruebaRendida.getAlumno().getCurso().getTipoCurso());
