...
public class InformeHabilidadXCurso implements IInforme {
    ...
    protected Map<R_Habilidad, List<OTPreguntasHabilidad>> procesar(List<R_EvaluacionPrueba> evaluacionesPrueba) {

        final Map<R_Habilidad, List<OTPreguntasHabilidad>> mapEjes = new HashMap<>();
        ...
        for (final R_EvaluacionPrueba eval : evaluacionesPrueba) {
            ...
            for (final R_PruebaRendida pruebaRendida : pruebasRendidas) {
                ...
                for (final R_Habilidad eje : mapEjes.keySet()) {
