...
public class ChartsUtil {
    ...
    public static File createBarChartSeries(String title, List<String> xValues,
            Map<String, List<Double>> yValues) throws IOException {
        final DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        for (String serie : yValues.keySet()) {
            for (int n = 0; n < xValues.size(); n++) {
