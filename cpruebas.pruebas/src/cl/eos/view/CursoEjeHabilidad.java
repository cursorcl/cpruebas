...
public class CursoEjeHabilidad {
   ...
   */
  private Pair<Integer, Integer> obtenerBuenasTotales(String respuestas, Habilidad hab) {
    int nroBuenas = 0;
    int nroPreguntas = 0;
   ...
   * @return Par <Preguntas buenas, Total de Preguntas> del eje.
   */
  private Pair<Integer, Integer> obtenerBuenasTotales(String respuestas, EjeTematico eje) {
    int nroBuenas = 0;
    int nroPreguntas = 0;
    for (int n = 0; n < respEsperadas.size(); n++) {
      RespuestasEsperadasPrueba resp = respEsperadas.get(n);
