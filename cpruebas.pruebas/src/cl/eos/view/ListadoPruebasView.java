...
public class ListadoPruebasView extends AFormView implements EventHandler<ActionEvent> {
	...
	/**
	 * Llama a la HMI que presenta si las respuestas de cada pregunta está
	 * buena, mala u omitida.
	 */
	private void handleRespuestasAlumno() {
		final ComparativoColegioXPregunta view = (ComparativoColegioXPregunta) show(
				"/colegio/fxml/ComparativoColegioXPreguntaView.fxml");
