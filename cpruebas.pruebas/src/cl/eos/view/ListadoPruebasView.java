...
public class ListadoPruebasView extends AFormView implements EventHandler<ActionEvent> {
    ...
    @FXML private MenuItem mnuPopupCrear;
    ...
    @FXML private MenuItem mnuXObjetivos;
    @FXML private MenuItem mnuXNivelObjetivos;
    ...
    private void handlerHabilidadEvaluacionXNivel() {
        final Nivel_ComparativoColegioHabilidadesView nivel_comparativocolegiohabilidadesview = (Nivel_ComparativoColegioHabilidadesView) show(
                "/colegio/nivel/fxml/Nivel_ComparativoColegioHabilidades.fxml");
        show(nivel_comparativocolegiohabilidadesview);
        Long idNivelEval = tblListadoPruebas.getSelectionModel().getSelectedItem().getPrueba().getNivelevaluacion_id();
        Map<String, Object> parameters = MapBuilder.<String, Object> unordered().put("nivelevaluacion_id", idNivelEval).build();
