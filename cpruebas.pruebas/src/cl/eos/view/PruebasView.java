...
public class PruebasView extends AFormView implements EventHandler<ActionEvent> {
	...
	private ResumenComparativoComunalView comparativoComunal;
	...
	private void handlerComparativoComunal() {
		if (comparativoComunal == null) {
			comparativoComunal = (ResumenComparativoComunalView) show("/cl/eos/view/ResumenComparativoComunal.fxml");
		} else {
