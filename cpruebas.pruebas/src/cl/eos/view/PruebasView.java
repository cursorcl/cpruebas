...
public class PruebasView extends AFormView implements EventHandler<ActionEvent> {
  ...
  private void handlerHabilidadEvaluacion() {
    ComparativoColegioHabilidadesView resumenHabilidades =
        (ComparativoColegioHabilidadesView) show("/cl/eos/view/ComparativoColegioHabilidades.fxml");
  ...
  private void handlerEjesEvaluacion() {
    ComparativoColegioEjeEvaluacionView resumenEjeEvaluacion =
        (ComparativoColegioEjeEvaluacionView) show("/cl/eos/view/ComparativoColegioEjeEvaluacion.fxml");
  ...
  private void handlerComparativoColegioEjeHabilidad() {
    ComparativoColegioEjeHabilidadView resumenColegioEjeHabiliadad =
        (ComparativoColegioEjeHabilidadView) show("/cl/eos/view/ComparativoColegioEjeHabilidad.fxml");
  ...
  private void handlerComparativoComunal() {
    ...
    comparativoComunal =
        (ComparativoComunalEjeView) show("/cl/eos/view/ComparativoComunalEje.fxml");
    // } else {
  ...
  private void handleEliminar() {
    ...
    ObservableList<OTPrueba> otSeleccionados =
  ...
  private void accionClicTabla() {
    tblListadoPruebas.setOnMouseClicked(new EventHandler<MouseEvent>() {
      ...
      public void handle(MouseEvent event) {
        ObservableList<OTPrueba> itemsSelec =
            tblListadoPruebas.getSelectionModel().getSelectedItems();
