...
public class ResumenEjesTematicosView extends AFormView {
	...
	@FXML
	private TableView<OTPreguntasHabilidad> tblEjeTematicos;
	@FXML
	...
	private void inicializarTablaHabilidades() {
		tblEjeTematicos.getSelectionModel().setSelectionMode(
	...
	private void accionClicTabla() {
		tblEjeTematicos.setOnMouseClicked(new EventHandler<MouseEvent>() {
			@Override
			public void handle(MouseEvent event) {
				ObservableList<OTPreguntasHabilidad> itemsSelec = tblEjeTematicos
	...
	public void onFound(IEntity entity) {
		if (entity instanceof EvaluacionPrueba) {
			...
			if (mapaHabilidades != null && !mapaHabilidades.isEmpty()) {
				...
				tblEjeTematicos.setItems(oList);
			}
		}
	}
