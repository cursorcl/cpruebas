...
public class R_Prueba extends AEntity {
    ...
    @SerializedName(value = "exigencia", alternate = { "EXIGENCIA" }) Integer exigencia;
    @SerializedName(value = "alternativas", alternate = { "ALTERNATIVAS" }) Integer alternativas;
    @SerializedName(value = "fecha", alternate = { "FECHA" }) Long fecha;
    @SerializedName(value = "puntajebase", alternate = { "PUNTAJEBASE" }) Integer puntajebase;
    @SerializedName(value = "nroformas", alternate = { "NROFORMAS" }) Integer nroformas;
    @SerializedName(value = "responses", alternate = { "RESPONSES" }) String responses;
    @SerializedName(value = "nropreguntas", alternate = { "NROPREGUNTAS" }) Integer nropreguntas;
    ...
    @SerializedName(value = "curso_id", alternate = { "TIPOCURSO_ID" }) Long curso_id;
    @SerializedName(value = "tipoprueba_id", alternate = { "TIPOPRUEBA_ID" }) Long tipoprueba_id;
    @SerializedName(value = "profesor_id", alternate = { "PROFESOR_ID" }) Long profesor_id;
    @SerializedName(value = "nivelevaluacion_id", alternate = { "NIVELEVALUACION_ID" }) Long nivelevaluacion_id;
    @SerializedName(value = "estado", alternate = { "ESTADO" }) int estado;
    /**
     * @return the id
     */
    ...
    /**
     * @param nivelevaluacion_id
     *            the nivelevaluacion_id to set
     */
