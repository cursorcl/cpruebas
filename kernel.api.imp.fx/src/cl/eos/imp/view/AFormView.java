...
public abstract class AFormView extends AView implements IFormView {
	...
	protected boolean confirmaEliminar() {
		String response = FXDialogs.showConfirm("Confirma eliminación",
				"Una vez borrado no se puede recuperar. Está seguro de borrar?", FXDialogs.OK, FXDialogs.CANCEL);
		return FXDialogs.OK.equals(response);
