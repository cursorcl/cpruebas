...
public abstract class AView implements IView {
	...
	public void show(Pane root, IView pane) {
		WindowManager.getInstance().show(root, pane.getPanel(), true);
	}

	public void show(IView pane) {
		WindowManager.getInstance().show(pane.getPanel(), true);
	}
	...
	public IView show(Pane root, String fxml) {
		...
		if (view != null) {
			WindowManager.getInstance().show(root, view.getPanel(), true);
		}
		return view;
	}
	...
	public IView show(String fxml) {
		...
		if (view != null) {
			WindowManager.getInstance().show(view.getPanel(), true);
		}
		return view;
	}
